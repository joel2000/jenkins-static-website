pipeline {
     environment {
       ...
       PORT_EXPOSED = "80" 
       APP_NAME = "webstatic"
       STG_API_ENDPOINT = "ip10-0-3-3-cemv8cgmjkegg872cck0-1993.direct.docker.labs.eazytraining.fr"
       STG_APP_ENDPOINT = "ip10-0-3-3-cemv8cgmjkegg872cck0-8080.direct.docker.labs.eazytraining.fr"
       PROD_API_ENDPOINT = "ip10-0-3-3-cemv8cgmjkegg872cck0-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "ip10-0-3-3-cemv8cgmjkegg872cck0-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "80"
