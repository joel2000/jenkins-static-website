pipeline {
     environment {
       ...
       PORT_EXPOSED = "80" 
       APP_NAME = "webstatic"
       STG_API_ENDPOINT = "ip10-0-2-4-ceiqsl8mjkegg872c29g-1993.direct.docker.labs.eazytraining.fr"
       STG_APP_ENDPOINT = "ip10-0-2-4-ceiqsl8mjkegg872c29g-80.direct.docker.labs.eazytraining.fr"
       PROD_API_ENDPOINT = "ip10-0-2-5-ceiqsl8mjkegg872c29g-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "ip10-0-2-5-ceiqsl8mjkegg872c29g-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "80"
            ...
            steps {
               script {
                 sh '''
                    ...
                    docker rm $IMAGE_NAME || echo "container does not exist"
