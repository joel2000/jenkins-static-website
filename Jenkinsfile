pipeline {
     environment {
       ...
       PORT_EXPOSED = "80" 
       APP_NAME = "webstatic"
       STG_API_ENDPOINT = "ip10-0-5-3-cem6dq8mjkegg872cai0-1993.direct.docker.labs.eazytraining.fr"
       STG_APP_ENDPOINT = "ip10-0-5-3-cem6dq8mjkegg872cai0-8080.direct.docker.labs.eazytraining.fr"
       PROD_API_ENDPOINT = "ip10-0-5-3-cem6dq8mjkegg872cai0-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "ip10-0-5-3-cem6dq8mjkegg872cai0-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "80"
